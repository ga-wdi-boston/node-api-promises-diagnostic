  ...
  return new Promise((resolve, reject) => {
    fs.readFile(filename, {encoding: 'utf8'}, (err, lines) => {
      if (err) {
        ...
        if (isNaN(sum)) {
          reject(new Error(`line ${lno}: not a number`));
        } else {
          resolve(sum);
        }
      }
...
// I didn't do anything here but I'm not sure if I should...?
// Though to be honest I'm not sure if I know how to turn this into a promise
